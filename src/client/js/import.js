import { numberOfDaysBeforeTrip, numberOfDaysForTrip } from "./uitis";
...
export const dataFromApi = async function(trip) {
    await Promise.all([
        (async() => {
            ...
            let coordinates = await fetch("http://localhost:4000/getCoordinates", {
                method: 'POST',
            ...
            let weatherData = await fetch("http://localhost:4000/getWeather", {
                method: 'POST',
                credentials: 'same-origin',
                mode: 'cors',
                headers: {
            ...
            let image = await fetch("http://localhost:4000/getImage", {
                method: 'POST',
                credentials: 'same-origin',
                mode: 'cors',
                headers: {
